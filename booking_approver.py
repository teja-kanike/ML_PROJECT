...
class BookingApprover:
    ...
    def train_model(self):
        ...
        try:
            ...
            print(f"✅ Booking Approver trained! Train Accuracy: {train_score:.4f}, Test Accuracy: {test_score:.4f}")
            ...
            print(f"❌ Error training booking approver: {e}")
    ...
    def load_model(self):
        ...
        try:
            ...
            print(f"Error loading booking approver: {e}")
            return False
    ...
    def predict_booking_approval(self, booking, occupancy_rate):
        ...
        try:
            ...
            print(f"Error in booking approval prediction: {e}")
            return self._fallback_approval(booking, occupancy_rate)
        ...
        try:
            ...
            for booking in pending_bookings:
                ...
                if prediction['approved'] and prediction['confidence'] > 0.6:
                    ...
                    print(f"✅ Auto-approved booking {booking.id} for {booking.student.full_name}")
                    print(f"   Confidence: {prediction['confidence']:.4f}")
                    print(f"   Occupancy: {current_occupancy}%")
            
            if approved_count > 0:
                db.session.commit()
                print(f"🎉 Auto-approved {approved_count} pending bookings!")
            
            return approved_count
            
        except Exception as e:
            print(f"Error in auto-approving bookings: {e}")
            return 0
